...
\startdata
\multicolumn{3}{c}{Variable $\alpha$: prior -- $N(2,1)$} & & \multicolumn{3}{c}{Fixed $\alpha$: $\alpha=2$}\\
\cline{1-3} \cline{5-7}
$t_\mathrm{fl}$ (MJD) & $\alpha_{\mathrm{ZTF}, r}$ & $\alpha_{\mathrm{ATLAS}, o}$ &  & \multicolumn{3}{c}{$t_{\mathrm{fl}, \alpha=2}$ (MJD)}\\
$59703.16^{+0.70}_{-0.58}$ & $2.18^{+0.20}_{-0.24}$ & $2.37^{+0.48}_{-0.20}$ & & \multicolumn{3}{c}{$59703.66^{+0.10}_{-0.11}$}\\
\hline

\begin{deluxetable}{ccccc} \label{tab:phot}
    ...
    \enddata
    \tablecomments{Observed fluxes in the ZTF, ATLAS, UVOT, LT, and KAIT passbands, since the first detection in $r_\mathrm{ZTF}$. Correction for reddening has not been applied.\\(This table is available in its entirety in machine readable form.)}
\end{deluxetable}